        ...
        <div class="app-modal-body">
          <div *ngIf="step === 'input'">
            ...
            <div class="diff-section" *ngIf="diff.forbidden?.length">
              ...
              <div class="hint" *ngIf="hiddenForbiddenCount > 0">{{ hiddenForbiddenCount }} more forbidden item(s) not shown.</div>
            </div>
          ...
          <div *ngIf="step === 'preview'">
            <div class="summary-section">
              ...
              <ul class="summary-list">
                ...
                <li *ngIf="forbiddenCount > 0" class="old">{{ 'admin.importForbiddenSummary' | t }}: {{ forbiddenCount }}</li>
              </ul>
